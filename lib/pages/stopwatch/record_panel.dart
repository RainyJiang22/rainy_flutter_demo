...
class RecordPanel extends StatelessWidget {
  ...
  RecordPanel({super.key, required this.record});
    ...
    return Padding(
      ...
      child: DefaultTextStyle(
        ...
        child: ListView.builder(
          itemBuilder: _buildItemByRecord,
  ...
  Widget _buildItemByRecord(BuildContext context, int index) {
    ...
    return Row(
      children: [
        ...
        Padding(
          padding: itemPadding,
          child: Text("+${durationToString(record[reverseIndex].record)}"),
        )
      ],
    );
  }
