...
class LaunchPageDemo extends StatefulWidget {
  const LaunchPageDemo({super.key, required this.title});

  final String title;

  @override
  State<LaunchPageDemo> createState() => _LaunchPageDemoState();
}

class _LaunchPageDemoState extends State<LaunchPageDemo> {
